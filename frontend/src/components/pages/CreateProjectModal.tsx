...
export function CreateProjectModal() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Nếu người dùng chọn ảnh tham chiếu phong cách, hãy tải lên sau khi tạo dự án
      if (styleImageFile) {
        try {
          await API.uploadStyleImage(projectName, styleImageFile);
        } catch {
          // Tải lên ảnh phong cách thất bại không chặn việc tạo dự án
          useAppStore.getState().pushToast(
            "Tải lên ảnh tham chiếu phong cách thất bại, bạn có thể tải lại sau trong cài đặt dự án",
            "warning"
          );
        }
      }
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              placeholder="Ví dụ: Sự trở lại của Nữ hoàng"
            ...
            <p className="mt-1 text-xs text-gray-600">
              Hệ thống sẽ tự động tạo ID nội bộ cho dự án để dùng cho URL và lưu trữ tệp
            </p>
          </div>
          ...
          <div>
            ...
            />
            <p className="mt-1 text-xs text-gray-600">
              Sau khi tải lên sẽ tự động phân tích đặc điểm phong cách để tạo ra hình ảnh nhất quán
            </p>
          </div>
