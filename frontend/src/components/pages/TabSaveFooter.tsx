...
/**
 * Cấu hình Footer lưu giữ của Tab.
 * - isDirty=false: Nhúng bình thường, nút lưu bị vô hiệu hóa
 * - isDirty=true:  sticky cố định ở dưới cùng của khung nhìn, nút lưu được làm nổi bật
 */
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 min-w-0">
        {isDirty && !error && (
          <span className="text-sm text-gray-400">Có thay đổi chưa lưu</span>
        )}
        {error && (
