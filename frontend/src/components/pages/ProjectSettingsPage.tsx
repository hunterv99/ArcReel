...
export function ProjectSettingsPage() {
  ...
  const guardedNavigate = useCallback((path: string) => {
    if (isDirty && !window.confirm("Có thay đổi chưa lưu, bạn có chắc chắn muốn rời đi không?")) return;
    navigate(path);
  }, [isDirty, navigate]);
      ...
      <div className="mx-auto max-w-2xl px-6 py-8 space-y-6">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500">
            Chọn mô hình tạo riêng cho dự án này, để trống để theo mặc định toàn cục
          </p>
        </div>
          ...
          <>
            ...
            <div className="rounded-xl border border-gray-800 bg-gray-950/40 p-4">
              ...
              <ProviderModelSelect
                ...
                allowDefault
                defaultHint={
                  globalDefaults.video ? `Hiện tại toàn cục: ${globalDefaults.video}` : undefined
                }
              />
            </div>
            ...
            <div className="rounded-xl border border-gray-800 bg-gray-950/40 p-4">
              ...
              <ProviderModelSelect
                ...
                allowDefault
                defaultHint={
                  globalDefaults.image ? `Hiện tại toàn cục: ${globalDefaults.image}` : undefined
                }
              />
            </div>
            ...
            <div className="rounded-xl border border-gray-800 bg-gray-950/40 p-4">
              ...
              <fieldset className="flex gap-4">
                <legend className="sr-only">Cài đặt tạo âm thanh</legend>
            ...
            <div className="rounded-xl border border-gray-800 bg-gray-950/40 p-4">
              ...
              <p className="mb-2 text-xs text-gray-500">Ghi đè theo loại tác vụ, để trống để theo mặc định toàn cục</p>
