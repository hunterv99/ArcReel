...
export function StudioLayout({ children }: StudioLayoutProps) {
  ...
  // Kết nối các luồng SSE khi vào không gian làm việc
  ...
  return (
    <div className="flex h-screen flex-col bg-gray-950 text-gray-100">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        >
          {/* Luôn render nhưng ẩn khi thu gọn để duy trì trạng thái */}
          <div
      ...
      {/* Quả cầu trợ lý lơ lửng — cố định ở góc trên bên phải khi thu gọn */}
      <button
        type="button"
