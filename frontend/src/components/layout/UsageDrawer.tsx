...
// ---------------------------------------------------------------------------
// UsageDrawer — Bảng chi tiết chi phí
// ---------------------------------------------------------------------------
    ...
    >
      ...
      <div className="max-h-72 overflow-y-auto">
        {callsLoading ? (
          ...
          <div className="flex items-center justify-center py-8 text-xs text-gray-500">Chưa có nhật ký gọi</div>
        ) : (
      ...
      {totalPages > 1 && (
        <div className="flex items-center justify-between border-t border-gray-800 px-4 py-2">
          <span className="text-[10px] text-gray-500">{total} mục</span>
...
function extractFilename(outputPath: string | null | undefined): string {
  ...
  // Ví dụ: "storyboards/scene_E1S01.png" → "scene_E1S01.png"
  // Ví dụ: "characters/GiangNguyetHoi.png" → "GiangNguyetHoi.png"
