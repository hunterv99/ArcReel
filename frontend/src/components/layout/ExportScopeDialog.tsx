...
function getDefaultDraftPath(): string {
  ...
  return isWindows
    ? String.raw`C:\Users\tên_người_dùng\AppData\Local\JianyingPro\User Data\Projects\com.lveditor.draft`
    : "/Users/tên_người_dùng/Movies/JianyingPro/User Data/Projects/com.lveditor.draft";
}
      ...
      {mode === "select" ? (
        <>
          ...
          <div className="flex flex-col gap-2">
            ...
            >
              ...
              <div>
                <div className="text-sm font-medium text-gray-200">
                  Xuất bản thảo CapCut (Jianying)
                </div>
                <p className="mt-0.5 text-xs text-gray-500">
                  Tạo tệp ZIP bản thảo có thể nhập vào CapCut
                </p>
              </div>
            </button>
          </div>
        ...
        <>
          <div className="mb-3 flex items-center gap-2">
            ...
            <p className="text-xs font-medium text-gray-300">Xuất bản thảo CapCut (Jianying)</p>
          </div>
          <div className="flex flex-col gap-3">
            ...
            <div>
              ...
              <select
                ...
                className="w-full rounded-md border border-gray-700 bg-gray-800 px-2.5 py-1.5 text-sm text-gray-200 outline-none focus:border-indigo-500"
              >
                <option value="6">CapCut 6.0 trở lên (Đề nghị)</option>
                <option value="5">CapCut 5.x</option>
              </select>
            </div>
            ...
            <div>
              ...
              <input
                ...
                placeholder="Đường dẫn thư mục bản thảo CapCut"
              ...
              <p className="mt-1.5 text-[11px] leading-relaxed text-gray-500">
                Vui lòng nhập đường dẫn đầy đủ đến thư mục bản thảo của CapCut. Mở CapCut → Cài đặt → Vị trí bản thảo để xem.
              </p>
            </div>
