        ...
        <div>
          <div className="mb-1 flex items-center justify-between">
            <label className="block text-xs font-medium text-gray-400">
              Ảnh tham khảo <span className="text-gray-600">(Tùy chọn)</span>
            </label>
            {referenceFile && (
          ...
          {referencePreview ? (
            <div className="relative overflow-hidden rounded-lg border border-gray-700 bg-gray-800">
              <img
                ...
                alt="Xem trước ảnh tham khảo nhân vật"
          ...
          <p className="mt-1 text-xs text-gray-600">
            Dùng để duy trì tính nhất quán của nhân vật khi tạo bản thiết kế sau này
          </p>
        </div>
