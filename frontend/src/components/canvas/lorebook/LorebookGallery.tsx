...
interface LorebookGalleryProps {
  ...
  /** Được gọi khi người dùng nhấp vào "Thêm nhân vật". */
  onAddCharacter?: () => void;
  /** Được gọi khi người dùng nhấp vào "Thêm manh mối". */
  onAddClue?: () => void;
}
        ...
        <>
          {charCount === 0 ? (
            <EmptyState
              ...
              message="Chưa có nhân vật, nhấp vào nút bên dưới để thêm"
            />
          ) : (
        ...
        <>
          {clueCount === 0 ? (
            <EmptyState
              ...
              message="Chưa có manh mối, nhấp vào nút bên dưới để thêm"
            />
          ) : (
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
