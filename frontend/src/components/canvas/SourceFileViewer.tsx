...
// ---------------------------------------------------------------------------
// SourceFileViewer — Component xem trước/chỉnh sửa tệp nguồn
// ---------------------------------------------------------------------------
...
export function SourceFileViewer({ projectName, filename }: SourceFileViewerProps) {
  ...
  const handleDelete = useCallback(async () => {
    if (!confirm(`Bạn có chắc chắn muốn xóa tệp "${filename}" không? Thao tác này không thể hoàn tác.`)) return;
    try {
