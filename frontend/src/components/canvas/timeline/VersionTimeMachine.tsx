          ...
          >
            {loading ? (
              ...
              <div className="space-y-1">
                <p className="text-[11px] font-medium text-gray-300">Chưa có phiên bản lịch sử</p>
                <p className="text-[11px] leading-5 text-gray-500">
                  Sau khi tạo hoặc khôi phục, các phiên bản lịch sử sẽ xuất hiện ở đây.
                </p>
              </div>
            ) : (
              <div className="space-y-3">
                ...
                {!selectedInfo && (
                  <p className="text-[10px] leading-4 text-gray-400">
                    Nhấp vào số phiên bản để xem trước, có thể chuyển sang các phiên bản không phải hiện tại.
                  </p>
                )}
                ...
                {selectedInfo && (
                  <div className="rounded-xl border border-gray-700 bg-gray-950/80 p-2.5">
                    ...
                    <p className="line-clamp-4 text-[11px] leading-5 text-gray-400">
                      {selectedInfo.prompt || "Phiên bản này không có mô tả bổ sung."}
                    </p>
