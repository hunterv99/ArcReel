...
describe("OverviewCanvas", () => {
  ...
  it("uploads and deletes the style reference image from the workspace", async () => {
    ...
    fireEvent.click(screen.getByRole("button", { name: "Xóa ảnh tham khảo" }));
  ...
  it("shows a save action only when style description is edited", async () => {
    ...
    fireEvent.change(
      screen.getByPlaceholderText(
        "Sau khi tải lên ảnh tham khảo phong cách, hệ thống sẽ tự động phân tích và điền mô tả phong cách; cũng có thể chỉnh sửa thủ công.",
      ),
      {
